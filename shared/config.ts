...
export const INVENTORY_SIZE_PER_CHARACTER = 10;
export const BASE_INVENTORY_SIZE = NB_START_CHARACTERS * INVENTORY_SIZE_PER_CHARACTER;
export const INVENTORY_SLOT_PRICE = 200;
